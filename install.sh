...
echo ""
echo "🦅 More hawk:"
echo "   • Terminal statusline with your live 5h/weekly Claude limits:"
echo "     https://github.com/jcsuen/claude-limits-statusline"
echo "   • Join the daily leverage leaderboard (opt-in, nickname only):"
echo "     echo yourname > ~/.sessionhawk/leaderboard"
echo "     https://paulobuilds.com/sessionhawk/leaderboard"
